...
CREATE OR REPLACE TABLE cf_aiv AS (
    ...
    raw AS (
        SELECT 
            ...
            {
                'company_numb': recode_company_code(companycode),
                'sym': policysymbol,
            ...
            } as insured,
            {
                ...
                'extra_expense_desc': EXTRAEXPENSEDESCRIPTIO, 
                'incl_rental_resolved': INCLUDINGRENTALRESOLVED, 
                'monthly_limitation': MONTHLYLIMITATIONQUANTIT, 
            } as coverage,
            {
            ...
            {
                'numb': LOCATIONNUMBER AS location_numb,  
                'risk': {
